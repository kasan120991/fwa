  ...
  <div class="flex flex-col gap-6">
    ...
    <div class="overflow-hidden rounded-card bg-default ring ring-default">
      <div class="flex flex-wrap items-center justify-between gap-3 px-6 py-3.5">
        ...
        <div class="flex items-center gap-2.5">
          <div class="inline-flex items-center gap-0.5 rounded-btn border border-default bg-muted p-0.5">
            <button
              v-for="f in ticketFilters"
              :key="f.key"
              class="inline-flex items-center gap-1.5 rounded-[6px] px-2.5 py-1 text-[12.5px] transition-colors"
      ...
      <NuxtLink
        ...
        :key="t.id"
        :to="`/support/${t.id}`"
        class="flex items-center gap-3 border-t border-default px-6 py-3.5 transition-colors hover:bg-muted"
      >
        <span
      ...
      <div
        ...
        class="border-t border-default px-6 py-8 text-center text-[13px] text-muted"
      >
    ...
    <div class="overflow-hidden rounded-card bg-default ring ring-default">
      ...
      <div
        v-for="c in calls"
        :key="c.id"
        class="flex gap-3.5 border-t border-default px-6 py-3.5"
      >
        <span class="inline-flex size-[34px] flex-none items-center justify-center rounded-btn bg-mist text-primary">
          <UIcon
            name="i-lucide-phone"
            class="size-[15px]"
          />
    ...
    <div class="overflow-hidden rounded-card bg-default ring ring-default">
      ...
      <template v-else>
        <div class="border-t border-default px-6 py-2">
          <div
          ...
          >
            <div class="flex flex-none flex-col items-center">
              <span
                class="inline-flex size-[30px] flex-none items-center justify-center rounded-btn"
