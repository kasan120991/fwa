...
Both projects co-deploy on one box. The Ops app is a Docker stack — `mysql` + `api` (:4000) +
...
use Nuxt UI and has its own primitives — follow `website/CLAUDE.md` before touching it.
